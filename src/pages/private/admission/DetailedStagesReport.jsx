...
const DetailedStagesReport = () => {
	...
	const exportToExcel = () => {
		if (!_isEmpty(column) && !_isEmpty(report)) {
			const excel = new Excel();
			excel
				.addSheet('Details Stages Report')
				.addColumns(
					column.map((col) => {
						delete col.render;
						return col;
				...
				.saveAs('Details Stages Report.xlsx');
		}
	};
	return (
		<Layout>
			...
			<Layout.Content className="container-fluid admission d-flex">
				<Spin spinning={loader}>
					<Card title={<div>Detailed Stages Report</div>}>
						{!_isEmpty(report) ? (
							<Form form={form}>
								<Table
									bordered
...
export default DetailedStagesReport;
